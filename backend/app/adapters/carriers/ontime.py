...
This module implements the OnTime carrier integration for creating shipments,
...
class OnTimeAdapter(CarrierAdapter):
    ...
    def __init__(self):
        ...
        self.endpoints = {
            ...
            "shipments_bulk": f"{self.base_url}/api/shipments/bulk",
            "tracking": f"{self.base_url}/api/shipments/{{shipment_id}}/tracking",
    ...
    async def create_shipment(self, order_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            csv_logger.log_operation(
                operation="create_ontime_shipment",
    ...
    async def create_shipments_bulk(self, orders_data: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        try:
            ...
            duration_ms = int((time.time() - start_time) * 1000)
            csv_logger.log_operation(
                operation="create_ontime_shipments_bulk",
                order_id="",
                status="SUCCESS",
    ...
    async def get_shipment_status(self, shipment_id: str) -> Dict[str, Any]:
        ...
        Args:
            shipment_id: OnTime shipment ID
        ...
        try:
            ...
            duration_ms = int((time.time() - start_time) * 1000)
            csv_logger.log_operation(
                operation="get_ontime_shipment_status",
    ...
    async def get_shipment_label(self, shipment_id: str) -> bytes:
        ...
        try:
            ...
            duration_ms = int((time.time() - start_time) * 1000)
            csv_logger.log_operation(
                operation="get_ontime_shipment_label",
                order_id=shipment_id,
                status="SUCCESS",
    ...
    async def cancel_shipment(self, shipment_id: str, cancel_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            duration_ms = int((time.time() - start_time) * 1000)
            csv_logger.log_operation(
                operation="cancel_ontime_shipment",
                order_id=shipment_id,
                status="SUCCESS",
    ...
    async def _create_shipment_mock(self, order_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        shipment_id = f"ONTIME-{hash(order_id) % 100000:05d}"
        
        # Generate tracking number (OnTime format: ONT + 8 digits)
        tracking_number = f"ONT{random.randint(10000000, 99999999)}"
        ...
        return {
            ...
            "carrier": "ONTIME",
            "status": "CREATED",
            "label_url": f"https://mock.ontime.com/labels/{shipment_id}.pdf",
    ...
    async def _get_shipment_status_mock(self, shipment_id: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "location": "Madrid, Spain" if status != "DELIVERED" else "Delivered"
        }
    ...
    async def _get_shipment_label_mock(self, shipment_id: str) -> bytes:
        ...
        In production, this would be a real PDF label.
        """
    ...
    async def _cancel_shipment_mock(self, shipment_id: str, cancel_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "refund_amount": round(random.uniform(0.0, 10.0), 2)
        }
    ...
    async def _create_shipment_real(self, order_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # TODO: implement real OnTime API integration
        raise NotImplementedError("Real OnTime API integration not implemented yet")
